...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `volunteer_system`.`faculties` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `volunteer_system`.`majors` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `volunteer_system`.`users` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `volunteer_system`.`activity_categories` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `volunteer_system`.`activities` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `volunteer_system`.`activity_applications` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `volunteer_system`.`activity_participation` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `volunteer_system`.`auth_tokens` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `volunteer_system`.`user_bans` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `volunteer_system`.`user_roles` ;
...
USE `volunteer_system`$$
DROP TRIGGER IF EXISTS `volunteer_system`.`update_user_ban_status` $$
USE `volunteer_system`$$
CREATE
...
USE `volunteer_system`$$
DROP TRIGGER IF EXISTS `volunteer_system`.`update_user_ban_status_on_deactivate` $$
USE `volunteer_system`$$
CREATE
DEFINER=`root`@`localhost`
TRIGGER `volunteer_system`.`update_user_ban_status_on_deactivate`
